Class('Scope.Provider.IFrame', {
    ...
    methods : {
        ...
        create : function (onLoadCallback) {
            ...
            if ('v' == '\v' || Boolean(this.parentWindow.msWriteProfilerMark)) {
                ...
                iframe.onreadystatechange = function () {
                    ...
                    if (me.cachedOnError && !iframe.contentWindow.onerror) iframe.contentWindow.onerror = me.cachedOnError
                }
            ...
            if (me.cachedOnError && !scope.onerror) scope.onerror = me.cachedOnError
        },
        ...
        cleanup : function () {
            ...
            // XXX there's a recommendation to delay the removal of the iframe
            // it however causes some troubles in Gantt tests
