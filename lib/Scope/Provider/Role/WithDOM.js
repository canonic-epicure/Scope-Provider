        ...
        batchRealize : function (callback) {
            ...
            Joose.A.each(this.getPreload(), function (preloadDesc) {
                ...
                if (typeof preloadDesc == 'string') {
                    ...
                    if (me.isCSS(preloadDesc)) 
                        html.push(me.getLinkTagString(preloadDesc))
                    else
                        html.push(me.getScriptTagString(preloadDesc))
                    
                } else
                    // { text : 'js' } case
                    html.push(me.getScriptTagString(null, preloadDesc.text))
            })
            ...
            doc.write([
                ...
                '<html>',
                    ...
                    '<body style="width: 100%; height: 100%" onload="(window.opener || window.parent).__SCOPE_READY__[' + id + ']()">',
                    '</body>',
                '</html>'
            ].join(''))
